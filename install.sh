...
echo
echo "  발행(선택):  /yt-push   (요약 내용에 맞는 주제 폴더로 git repo 에 올리기 — 폴더는 Claude 가 판단)"
echo "    └ 먼저 '발행 루트'(주제 폴더들이 들어갈 상위 폴더)를 환경변수로 지정하세요(미설정 시 발행만 비활성):"
echo "       export YT_PUBLISH_DIR=\"\$HOME/Desktop/dev-lab/study\"   # ~/.zshrc 에 추가"
